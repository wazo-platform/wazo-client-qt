...
void MainWidget::setMainWindow(MainWindow * main_window)
{
...
void MainWidget::setStatusLogged()
{
    qDebug() << Q_FUNC_INFO;
    ...
    if ((this->m_resizingHelper == 0) && (this->m_docks.size())) {
        ...
        this->m_resizingHelper = new QDockWidget(this);
...
void MainWidget::setStatusNotLogged()
{
    qDebug() << Q_FUNC_INFO;
