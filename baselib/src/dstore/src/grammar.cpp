...
#endif
#define ParseARG_SDECL  ParserRet* arg ;
...
static const char *const yyTokenName[] = { 
  "$",             "SLASH",         "LC",            "TEST",        
  "RC",            "AT",            "CHARACTER",     "error",       
  "expr",          "midexpr",       "path",          "pathfrag",    
  "value",         "treepart",    
};
#endif /* NDEBUG */
...
static void yy_reduce(
  ...
  **     break;
  */
      case 0: /* treepart ::= expr */
#line 53 "src/grammar.ly"
{
...
#line 67 "src/grammar.ly"
{
    ...
    yygotominor.yy1->append(tree->extractVariant(""));
    delete tree;
